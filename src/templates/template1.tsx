...
function template1({ templateSchema }: template1Props) {
  ...
  return (
    ...
    >
      ...
      <div className="grid h-full grid-cols-1 gap-x-10 gap-y-7 max-sm:grid-rows-[auto_1fr] sm:grid-cols-2 p-4 max-w-screen-xl mx-auto">
        ...
        <div className="flex justify-center items-center max-h-full  rounded-2xl">
          <img
            ...
            className="h-full max-h-[500px] min-w-full object-fill rounded-lg border-2"
            alt="section image"
          />
        </div>
      </div>
